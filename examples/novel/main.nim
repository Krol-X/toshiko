...
var
  ...
  # Charapters:
  akiko_default = load("assets/test.png")
...
background_image.texture_mode = TEXTUREMODE_KEEP_ASPECT_RATIO
...
charapter.texture_mode = TEXTUREMODE_KEEP_ASPECT_RATIO
charapter.hide()
